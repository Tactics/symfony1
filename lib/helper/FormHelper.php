...
function select_tag($name, $option_tags = null, $options = array())
{
  ...
  $select = content_tag('select', $option_tags, array_merge(array('name' => $name, 'id' => get_id_from_name($id)), $options));
  return content_tag('span', $select, array('class' => 'form-select'));
}
