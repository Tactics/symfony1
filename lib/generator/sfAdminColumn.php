...
class sfAdminColumn
{
     ...
     */
    public function __construct($phpName, $column = \null, $flags = array())
    {
    ...
    {
        return \in_array('_', $this->flags) ? \true : \false;
    }
    /**
    ...
    {
        return \in_array('~', $this->flags) ? \true : \false;
    }
    /**
    ...
    {
        return \in_array('=', $this->flags) || $this->isPrimaryKey() ? \true : \false;
    }
    /**
