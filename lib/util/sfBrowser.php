...
class sfBrowser
{
    protected $context = \null, $hostname = \null, $remote = \null, $dom = \null, $stack = array(), $stackPosition = -1, $cookieJar = array(), $fields = array(), $vars = array(), $defaultServerArray = array(), $currentException = \null;
    ...
    public function call($uri, $method = 'get', $parameters = array(), $changeStack = \true)
    {
        $uri = $this->fixUri($uri);
        ...
        \sfConfig::set('sf_rendering_filter', array('sfFakeRenderingFilter', \null));
    ...
    {
        if (\null === $this->getContext()->getResponse()->getHttpHeader('Location')) {
    ...
    {
        $this->defaultServerArray['session_id'] = $_SERVER['session_id'] = \md5(\uniqid(\rand(), \true));
    }
}
